...
public class AdminCompilationController {
    ...
    public ResponseEntity<CompilationDto> addCompilation(
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(compilationService.create(adminCompilationDto));
    }
    ...
    public ResponseEntity<CompilationDto> updateCompilation(
        ...
        return ResponseEntity.status(HttpStatus.OK).body(compilationService.update(adminCompilationDto, compId));
    }
